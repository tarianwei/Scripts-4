...
FileLoon=$WorkDir/Loon/JD_DailyBonus_Gallery.conf
FileQx=$WorkDir/QuantumultX/JD_DailyBonus_Gallery.json
FileQxRe=$WorkDir/QuantumultX/JD_DailyBonus_Cookies.conf
FileSurge=$WorkDir/Surge/JD_DailyBonus_Gallery.sgmodule

## task清单顶部内容
CommentsLoon="# IOS Loon Task&Cookies配置 By TongLin138\n# GitHub主页(https://github.com/TongLin138/Scripts)\n# TG讨论组 (https://t.me/JD_fruit_pet)\n# TG通知频道 (https://t.me/jdfruit)\n# Loon的Task&Cookies脚本订阅链接: https://raw.githubusercontent.com/TongLin138/Scripts/main/Loon/lxk0301_LoonTask.conf\n# 使用方法:打开APP，顶部的配置 -> 脚本 -> 订阅脚本- > 点击右上角+号 -> 添加url链接 (https://raw.githubusercontent.com/TongLin138/Scripts/main/Loon/lxk0301_LoonTask.conf)\n\nhostname = api.m.jd.com, draw.jdfcloud.com, jdjoy.jd.com, account.huami.com"
CommentsQx='{\n  "name": "TongLin138 task gallery",\n  "description": "https://github.com/TongLin138/Scripts",\n  "task": ['
CommentsQxRe="hostname = api.m.jd.com, draw.jdfcloud.com, jdjoy.jd.com, account.huami.com"

CommentsSurgeHead="#!name=TongLin138 iOS Tasks&Cookies Module\n#!desc=iOS Tasks&Cookies 模块配置\n\n# Task&Cookies模块配置 By TongLin138\n# GitHub主页(https://github.com/TongLin138/Scripts)\n# TG讨论组 (https://t.me/JD_fruit_pet)\n# TG通知频道 (https://t.me/jdfruit)\n# Surge的Task&Cookies脚本模块地址: https://raw.githubusercontent.com/TongLin138/Scripts/main/Surge/lxk0301_Task.sgmodule.sgmodule\n\n[Script]"
