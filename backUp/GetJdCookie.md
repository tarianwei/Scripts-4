...
2. 按键盘F12键打开开发者工具，然后点下图中的图标
 ![切换到手机模式](https://raw.githubusercontent.com/TongLin138/Module/main/icon/jd1.jpg)
3. 此时是未登录状态(使用手机短信验证码登录)，如已登录请忽略此步骤
     - 使用手机短信验证码登录(此方式cookie有效时长大概31天，其他登录方式比较短)
4. 登录后，选择Network,有很多链接的话点箭头这里清空下
    ![清空](https://raw.githubusercontent.com/TongLin138/Module/main/icon/jd2.jpg)
5. 然后再点我的，链接就变少了
    ![再次点击我的](https://raw.githubusercontent.com/TongLin138/Module/main/icon/jd3.jpg)
6. 点第一个链接(log.gif)进去，找到cookie，复制出来，新建一个TXT文本临时保存一下，下面需要用到
 ![寻找log.gi](https://raw.githubusercontent.com/TongLin138/Module/main/icon/jd4.jpg)
